...
| 5. Create FileStorage class | [/models/engine/file_storage.py] [/models/_ _init_ _.py] [/models/base_model.py] | Class that handles the JSON serialization and deserialization of a file, and reloads the content of the file to be used within the program through multiple sessions|
...
| 9. More Classes | [/models/user.py] [/models/place.py](https://github.com/justinmajetich/AirBnB_clone/blob/dev/models/place.py) [/models/city.py]) [/models/amenity.py] | Add more classes to store various information through the file storage system, and to seperate similar types |
